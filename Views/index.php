    ...
    <div id="my_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">NOVI<br>Un mundo familiar</h1>
              <div class="buynow_bt"><a href="#">COMPRA</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital"><br>Bienvenidos!!</h1>
              <div class="buynow_bt"><a href="#">OFERTAS</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital"><br>NOVI GROUP</h1>
              <div class="buynow_bt"><a href="#">UWU</a></div>
            </div>
          </div>
        </div>
      </div>
